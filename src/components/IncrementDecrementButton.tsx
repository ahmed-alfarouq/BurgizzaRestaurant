...
const IncrementDecrementButton = React.memo(function IncrementDecrementButton({
  increase,
  decrease,
  quantity,
  itemName,
  ...
  return (
    <div className={styles.container}>
      <button type="button" className={styles.decrement_btn} onClick={decrease}>
        <span className="sr-only">Decrease {itemName} quantity</span>
        <BiMinus aria-hidden="true" />
      </button>
      <span className={styles.quantity}>{quantity}</span>
      <button type="button" className={styles.increment_btn} onClick={increase}>
